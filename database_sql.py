...
class SQLDatabase(Database):
    ...
    CREATE_SONGS_TABLE = """
        ...
        SONGS_TABLENAME, Database.FIELD_SONG_ID, Database.FIELD_SONG_NAME, FIELD_FINGERPRINTED,
    ...
    INSERT_SONG = "INSERT INTO %s (%s, %s, %s) values (%%s, %%s, UNHEX(%%s));" % (
        SONGS_TABLENAME, Database.FIELD_SONG_ID, Database.FIELD_SONG_NAME, Database.FIELD_FILE_SHA1)
    ...
    """ % (Database.FIELD_SONG_NAME, Database.FIELD_FILE_SHA1, Database.FIELD_FILE_SHA1, SONGS_TABLENAME, Database.FIELD_SONG_ID)
    ...
    """ % (Database.FIELD_SONG_ID, Database.FIELD_SONG_NAME, Database.FIELD_FILE_SHA1, Database.FIELD_FILE_SHA1,
    ...
    def insert_song(self, songId, songname, file_hash):
        """
        Inserts song in the database and returns the ID of the inserted record.
        """
        with self.cursor() as cur:
            cur.execute(self.INSERT_SONG, (songId, songname, file_hash))
