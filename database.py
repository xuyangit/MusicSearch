...
class Database(object):
    ...
    FIELD_ALBUM__NAME = "album__name"
    FIELD_SINGERS = "singers"
    FIELD_ARTISTID = "artistId"
    FIELD_SONGWRITERS = "songwriters"
    FIELD_COMPOSER = "composer"
    FIELD_PLAYCOUNT = "playCount"
    FIELD_FILE_SHA1 = 'file_sha1'
    FIELD_SONG_ID = 'songId'
    FIELD_SONG_NAME = 'songName'
    FIELD_HASH = 'hash'
    FIELD_OFFSET = "offset"
